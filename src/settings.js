...
export function createSettings(deps) {
  ...
  function openSettings() {
    ...
    <div class="form-group"><label class="form-label">AI Model</label><select class="form-input" id="fAiModel" aria-label="AI Model">
      <option value="claude-haiku-4-5-20251001"${settings.aiModel === 'claude-haiku-4-5-20251001' || !settings.aiModel ? ' selected' : ''}>Haiku 4.5 \u2014 fast, good for daily tasks</option>
